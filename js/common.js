$(document).ready(function () {
    ...
    $('.main-issue .weather>ul').slick(
        {speed: 1000, autoplay: true, vertical: true, arrows: false}
    );
    ...
    $('.sub-view-head .image ul').slick({
        ...
        customPaging: function (slider, i) {
            // FYI just have a look at the object to find available information press f12 to
            // access the console in most browsers you could also debug or look in the
            // source
            console.log(slider);
